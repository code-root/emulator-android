...
DEVICE_CREATION_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    # S24 series presets
    "samsung_sm_s921b_android14": {
        "label": "Samsung Galaxy S24 (SM-S921B) · Android 14 · Exynos 2400",
    ...
    "samsung_sm_s926b_android14": {
        "label": "Samsung Galaxy S24+ (SM-S926B) · Android 14 · Exynos 2400",
    ...
    "samsung_sm_s928b_android14": {
        "label": "Samsung Galaxy S24 Ultra (SM-S928B) · Android 14 · Snapdragon 8 Gen 3",
    ...
    "samsung_sm_s741b_android15": {
        "label": "Samsung Galaxy S24 FE (SM-S741B) · Android 15 · Exynos 2500",
        "device_model": "SM-S741B",
        "api_level": 35,
        "arch": "x86_64",
        "ram_mb": 8192,
        "cpu_cores": 8,
    ...
    "samsung_sm_a546b_android13": {
        "label": "Samsung Galaxy A54 (SM-A546B) · Android 13 · Exynos 1380",
...
DEVICE_PROFILES = [
    ...
    # S24 series
    {
        "device_model": "SM-S921B",  # Samsung Galaxy S24
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "e1s",
        "board": "pineapple",
        "hardware": "exynos",
        "build_fingerprint": "samsung/e1sxeea/e1s:14/AP2B.240214.120/S921BXXU3CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "S921BXXU3CXJ1",
        "csc_version": "S921BOXM3CXJ1",
    ...
    {
        "device_model": "SM-S926B",  # Samsung Galaxy S24+
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "e2s",
        "board": "pineapple",
        "hardware": "exynos",
        "build_fingerprint": "samsung/e2sxeea/e2s:14/AP2B.240214.120/S926BXXU3CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "S926BXXU3CXJ1",
        "csc_version": "S926BOXM3CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 34,
        "soc_model": "S5E9945",
        "soc_manufacturer": "Samsung",
    ...
    {
        "device_model": "SM-S928B",  # Samsung Galaxy S24 Ultra
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "e3s",
        "board": "pineapple",
        "hardware": "qcom",
        "build_fingerprint": "samsung/e3sxeea/e3s:14/AP2B.240214.120/S928BXXS3CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "S928BXXS3CXJ1",
        "csc_version": "S928BOXM3CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 34,
        "soc_model": "SM8650",
        "soc_manufacturer": "QTI",
    ...
    # S23/S21 FE series
    {
        ...
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "r11s",
        "board": "kalama",
        "hardware": "qcom",
        "build_fingerprint": "samsung/r11sxeea/r11s:14/AP2A.240214.120/S711BXXU3CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "S711BXXU3CXJ1",
        "csc_version": "S711BXEF3CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 33,
        "soc_model": "SM8475",
        "soc_manufacturer": "QTI",
    ...
    {
        "device_model": "SM-S741B",  # Samsung Galaxy S24 FE
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "r12s",
        "board": "pineapple",
        "hardware": "exynos",
        "build_fingerprint": "samsung/r12sxeea/r12s:15/AP3A.240301.001/S741BXXSACZC1:user/release-keys",
        "sdk_version": 35,
        "android_version": "15",
        "ap_version": "S741BXXSACZC1",
        "csc_version": "S741BXSPACZC1",
    ...
    {
        "device_model": "SM-G990B",  # Samsung Galaxy S21 FE
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "r9s",
        "board": "lahaina",
        "hardware": "qcom",
        "build_fingerprint": "samsung/r9sxeea/r9s:14/AP2A.240214.120/G990BXXU7CVJ2:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "G990BXXU7CVJ2",
        "csc_version": "G990BXEF7CVJ2",
        "security_patch": "2025-02-01",
        "first_api_level": 31,
        "soc_model": "SM8350",
        "soc_manufacturer": "QTI",
    ...
    # A-series (Galaxy A)
    {
        "device_model": "SM-A556B",  # Samsung Galaxy A55
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "a55x",
        "board": "mt6886",
        "hardware": "mt6886",
        "build_fingerprint": "samsung/a55xeea/a55x:14/AP2A.240214.120/A556BXXS4CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "A556BXXS4CXJ1",
        "csc_version": "A556BOXM4CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 34,
        "soc_model": "MT6886",
    ...
    {
        "device_model": "SM-A546B",  # Samsung Galaxy A54
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "a54x",
        "board": "s5e8835",
        "hardware": "exynos",
        "build_fingerprint": "samsung/a54xeea/a54x:13/TP1A.220624.014/A546BXXS7CXJ1:user/release-keys",
        "sdk_version": 33,
        "android_version": "13",
        "ap_version": "A546BXXS7CXJ1",
        "csc_version": "A546BOXM7CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 32,
        "soc_model": "S5E8835",
        "soc_manufacturer": "Samsung",
    ...
    {
        "device_model": "SM-A346B",  # Samsung Galaxy A34
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "a34x",
        "board": "mt6877",
        "hardware": "mt6877",
        "build_fingerprint": "samsung/a34xeea/a34x:13/TP1A.220624.014/A346BXXS5CXH1:user/release-keys",
        "sdk_version": 33,
        "android_version": "13",
        "ap_version": "A346BXXS5CXH1",
        "csc_version": "A346BOXM5CXH1",
        "security_patch": "2025-02-01",
        "first_api_level": 32,
        "soc_model": "MT6877V",
        "soc_manufacturer": "MediaTek",
    ...
    {
        "device_model": "SM-A256B",  # Samsung Galaxy A25
        "manufacturer": "Samsung",
        "brand": "samsung",
        "device_codename": "a25x",
        "board": "s5e8535",
        "hardware": "exynos",
        "build_fingerprint": "samsung/a25xeea/a25x:14/AP2A.240214.120/A256BXXS4CXJ1:user/release-keys",
        "sdk_version": 34,
        "android_version": "14",
        "ap_version": "A256BXXS4CXJ1",
        "csc_version": "A256BOXM4CXJ1",
        "security_patch": "2025-02-01",
        "first_api_level": 33,
        "soc_model": "S5E8535",
        "soc_manufacturer": "Samsung",
