...
class Device(Base):
    ...
    # avd = محاكي Google AVD؛ physical = هاتف/تابلت حقيقي عبر ADB (روم سامسونغ فعلي)
    emulator_kind = Column(String(16), default="avd", nullable=False)
    host_adb_serial = Column(String(64), nullable=True)
